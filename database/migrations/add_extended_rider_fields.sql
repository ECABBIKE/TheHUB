...
ALTER TABLE riders
  -- Address information
  ADD COLUMN IF NOT EXISTS personnummer VARCHAR(15) AFTER birth_year,
...
ALTER TABLE riders
  ADD INDEX IF NOT EXISTS idx_personnummer (personnummer),
...
ALTER TABLE riders COMMENT = 'PRIVACY: Fields personnummer, address, postal_code, phone, emergency_contact are PRIVATE and must not be exposed publicly';
