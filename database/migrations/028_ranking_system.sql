...
-- Description: Creates tables for the 24-month rolling ranking system for GravitySeries riders
-- Date: 2025-11-24
...
-- Monthly ranking snapshots for tracking position changes
CREATE TABLE IF NOT EXISTS ranking_snapshots (
    ...
    UNIQUE KEY unique_rider_snapshot (rider_id, snapshot_date),
    INDEX idx_snapshot_date (snapshot_date),
    INDEX idx_ranking_position (snapshot_date, ranking_position),
...
CREATE TABLE IF NOT EXISTS ranking_history (
    ...
    UNIQUE KEY unique_rider_month (rider_id, month_date),
    INDEX idx_rider_history (rider_id, month_date DESC),
...
('series_filter', '["GravitySeries Total"]', 'Series names to include in ranking'),
