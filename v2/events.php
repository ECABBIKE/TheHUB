...
?>
 ...
 <div class="container">
  ...
  <form method="GET" action="" id="filterForm" class="grid grid-cols-1 md-grid-cols-2 gap-md">
   <!-- Series Filter -->
   <div>
   <label class="label">Serie</label>
   <select name="series" class="input" onchange="document.getElementById('filterForm').submit()">
   ...
   <select name="format" class="input" onchange="document.getElementById('filterForm').submit()">
  ...
  <div class="card text-center gs-p-3xl">
   <i data-lucide="calendar-x" class="gs-empty-icon"></i>
   <h3 class="mb-sm">Inga tävlingar hittades</h3>
   <p class="text-secondary">
  ...
  <div class="events-two-column">
   ...
   <?php if (empty($upcomingEvents)): ?>
    <div class="card text-center gs-p-2xl">
    <i data-lucide="calendar-x" class="gs-empty-icon-md"></i>
    <p class="text-secondary">Inga kommande tävlingar</p>
    </div>
   <?php else: ?>
   ...
   <?php if (empty($completedEvents)): ?>
    <div class="card text-center gs-p-2xl">
    <i data-lucide="calendar-x" class="gs-empty-icon-md"></i>
    <p class="text-secondary">Inga avklarade tävlingar</p>
    </div>
   <?php else: ?>
    <div class="event-list">
