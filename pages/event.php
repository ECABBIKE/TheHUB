...
<div id="galleryLightbox" class="gallery-lightbox" style="display: none;">
    ...
    <div class="gallery-lightbox-content">
        ...
        <!-- Taggade deltagare visas under bilden -->
...
.gallery-item-tag {
    font-size: 0.6rem;
    color: #fff;
    background: rgba(55, 212, 214, 0.7);
    padding: 1px 5px;
    border-radius: var(--radius-full);
    white-space: nowrap;
}
...
.gallery-lightbox-tag {
    font-size: 0.8rem;
    color: #fff;
    background: rgba(55, 212, 214, 0.3);
    border: 1px solid rgba(55, 212, 214, 0.5);
    padding: 2px 10px;
    border-radius: var(--radius-full);
    text-decoration: none;
...
.gallery-lightbox-tag:hover {
    background: rgba(55, 212, 214, 0.5);
    color: #fff;
}
...
.gallery-tag-toggle {
    ...
    right: var(--space-md);
    z-index: 2;
    background: rgba(55, 212, 214, 0.8);
    border: none;
    color: #fff;
    width: 44px;
    height: 44px;
