...
<div class="club-header card">
    ...
    <div class="club-info">
        ...
        <a href="/v3/database/club/<?= $selectedClubId ?>" class="club-link">Visa klubbsida →</a>
    </div>
    <a href="/v3/profile/edit-club/<?= $selectedClubId ?>" class="btn btn-outline">Redigera klubb</a>
</div>
...
<div class="members-section">
    <div class="section-header">
        ...
        <a href="/v3/profile/add-member/<?= $selectedClubId ?>" class="btn btn-primary btn-sm">+ Lägg till</a>
    </div>
            ...
            <?php foreach ($members as $member): ?>
                <div class="member-card">
                    ...
                    <div class="member-info">
                        <a href="/v3/database/rider/<?= $member['id'] ?>" class="member-name">
...
function removeMember(riderId, name) {
    if (confirm(`Ta bort ${name} från klubben?`)) {
        window.location.href = `/v3/api/club.php?action=remove_member&rider_id=${riderId}&club_id=<?= $selectedClubId ?>`;
    }
}
</script>
