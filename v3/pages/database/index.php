...
<div class="database-grid">
    ...
    <div class="card">
        ...
        <div class="ranking-list">
            ...
            <a href="/v3/rider/<?= $rider['id'] ?>" class="ranking-item">
        ...
        <a href="/v3/ranking" class="card-link">Visa fullständig ranking →</a>
    </div>
    ...
    <div class="card">
        ...
        <div class="ranking-list">
            ...
            <a href="/v3/club/<?= $club['id'] ?>" class="ranking-item">
                <span class="ranking-pos <?= $i < 3 ? 'top-' . ($i + 1) : '' ?>">
                    <?php if ($i === 0): ?>🥇<?php elseif ($i === 1): ?>🥈<?php elseif ($i === 2): ?>🥉<?php else: ?><?= $i + 1 ?><?php endif; ?>
                </span>
                <div class="ranking-info">
...
<div class="card">
    ...
    <div class="recent-grid">
        ...
        <a href="/v3/rider/<?= $rider['id'] ?>" class="recent-item">
...
<div class="card">
    ...
    <div class="alphabet-grid">
        <?php foreach (range('A', 'Z') as $letter): ?>
            <a href="/v3/riders?letter=<?= $letter ?>" class="letter-btn"><?= $letter ?></a>
        <?php endforeach; ?>
        <a href="/v3/riders?letter=Å" class="letter-btn">Å</a>
        <a href="/v3/riders?letter=Ä" class="letter-btn">Ä</a>
        <a href="/v3/riders?letter=Ö" class="letter-btn">Ö</a>
    </div>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    searchInput.addEventListener('input', function() {
        ...
        searchTimeout = setTimeout(() => {
            fetch('/v3/api/search.php?type=' + currentType + '&q=' + encodeURIComponent(query))
                .then(r => r.json())
                .then(data => {
                    ...
                    if (data.results && data.results.length > 0) {
                        searchResults.innerHTML = data.results.map(item => {
                            if (currentType === 'riders') {
                                return '<a href="/v3/rider/' + item.id + '" class="search-result">' +
                                ...
                                return '<a href="/v3/club/' + item.id + '" class="search-result">' +
