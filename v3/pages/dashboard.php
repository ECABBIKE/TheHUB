...
<div class="page-grid">
  ...
  <section class="card grid-full">
    ...
    <div class="flex flex-wrap gap-sm">
      <a href="/v3/riders" class="btn btn--primary">👥 Åkare</a>
      <a href="/v3/clubs" class="btn btn--primary">🛡️ Klubbar</a>
      <a href="/v3/results" class="btn btn--primary">🏁 Resultat</a>
      <a href="/v3/series" class="btn btn--primary">🏆 Serier</a>
    </div>
  </section>
