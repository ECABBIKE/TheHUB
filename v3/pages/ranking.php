...
<div class="discipline-tabs mb-md">
  <a href="/v3/ranking?discipline=GRAVITY&view=<?= $view ?>"
     class="discipline-tab <?= $discipline === 'GRAVITY' ? 'active' : '' ?>">
    Gravity
  </a>
  <a href="/v3/ranking?discipline=ENDURO&view=<?= $view ?>"
     class="discipline-tab <?= $discipline === 'ENDURO' ? 'active' : '' ?>">
    Enduro
  </a>
  <a href="/v3/ranking?discipline=DH&view=<?= $view ?>"
...
<div class="view-toggle mb-lg">
  <a href="/v3/ranking?discipline=<?= $discipline ?>&view=riders"
     class="view-btn <?= $view === 'riders' ? 'active' : '' ?>">
    👤 Åkare
  </a>
  <a href="/v3/ranking?discipline=<?= $discipline ?>&view=clubs"
...
<section class="card">
  <div class="table-wrapper">
    <table class="table table--striped table--hover">
      ...
      <tbody>
        ...
        <tr onclick="window.location='/v3/club/<?= $club['club_id'] ?>'" style="cursor:pointer">
          <td class="text-center">
          ...
          <td class="col-club">
            <a href="/v3/club/<?= $club['club_id'] ?>" class="club-link">
  ...
  <div class="result-list">
    <?php foreach ($ranking['clubs'] as $club): ?>
    <a href="/v3/club/<?= $club['club_id'] ?>" class="result-item">
...
<nav class="pagination mt-lg" aria-label="Sidnavigering">
  <?php if ($page > 1): ?>
    <a href="/v3/ranking?discipline=<?= $discipline ?>&view=<?= $view ?>&page=<?= $page - 1 ?>" class="btn btn--ghost">← Föregående</a>
  <?php endif; ?>

  <span class="pagination-info">Sida <?= $page ?> av <?= $totalPages ?></span>

  <?php if ($page < $totalPages): ?>
    <a href="/v3/ranking?discipline=<?= $discipline ?>&view=<?= $view ?>&page=<?= $page + 1 ?>" class="btn btn--ghost">Nästa →</a>
  <?php endif; ?>
</nav>
<?php endif; ?>
