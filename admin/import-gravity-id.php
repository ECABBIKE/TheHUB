...
<main class="gs-main-content">
    <div class="gs-container">
        ...
        <div class="gs-grid gs-grid-cols-2 gs-gap-md gs-mb-lg">
            <div class="gs-card">
                <div class="gs-card-content gs-text-center">
                    <div class="gs-text-2xl gs-text-primary"><?= $gravityStats['with_id'] ?? 0 ?></div>
                    <div class="gs-text-sm gs-text-secondary">Deltagare med Gravity ID</div>
                </div>
            </div>
            <div class="gs-card">
                <div class="gs-card-content gs-text-center">
                    <div class="gs-text-2xl gs-text-secondary"><?= $gravityStats['total'] ?? 0 ?></div>
                    <div class="gs-text-sm gs-text-secondary">Totalt antal deltagare</div>
                </div>
            </div>
        </div>
            ...
            <div class="gs-card-content">
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="gs-form-group gs-mb-md">
                        <label class="gs-label">CSV-fil med Gravity ID</label>
                    ...
                    <div class="gs-flex gs-gap-md">
                        ...
                        <a href="?template=1" class="gs-btn gs-btn-outline">
        ...
        <div class="gs-card gs-mb-lg">
            ...
            <div class="gs-card-content">
                <ol class="gs-text-sm">
                    <li class="gs-mb-sm"><strong>UCI-ID</strong> - Mest pålitligt, matchar på licensnummer</li>
                    <li class="gs-mb-sm"><strong>E-post</strong> - Matchar på e-postadress</li>
                    <li class="gs-mb-sm"><strong>Namn + Födelseår</strong> - Matchar på förnamn, efternamn och födelseår</li>
                            ...
                            <tbody>
                                <?php foreach ($results as $result): ?>
                                    <tr class="<?= $result['status'] === 'not_found' ? 'gs-bg-danger-light' : '' ?>">
                                        <td><code class="gs-text-primary"><?= h($result['gravity_id']) ?></code></td>
                                        <td>
                                            <strong><?= h($result['input_name']) ?></strong>
                                            <?php if ($result['input_uci']): ?>
                                                <br><small class="gs-text-secondary">UCI: <?= h($result['input_uci']) ?></small>
                                            <?php endif; ?>
                                            <?php if ($result['input_email']): ?>
                                                <br><small class="gs-text-secondary"><?= h($result['input_email']) ?></small>
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            ...
                                            <?php else: ?>
                                                <span class="gs-text-danger">Ej hittad</span>
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            <?php if ($result['match_method']): ?>
                                                <span class="gs-badge gs-badge-info"><?= h($result['match_method']) ?></span>
                                            <?php else: ?>
                                                -
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            <?php if ($result['status'] === 'updated'): ?>
                                                <span class="gs-badge gs-badge-success">Tilldelad</span>
                                            <?php else: ?>
                                                <span class="gs-badge gs-badge-danger">Ej matchad</span>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
