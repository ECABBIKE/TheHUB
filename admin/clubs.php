 ...
 <div class="container">
  ...
  <div id="clubModal" class="gs-modal gs-modal-hidden">
   ...
   <form method="POST" id="clubForm">
    ...
    <button type="button" class="btn btn--secondary" onclick="closeClubModal()">
     Avbryt
    </button>
  ...
  <div class="card-body">
   <form method="GET" id="searchForm" class="flex gap-md items-center">
   <div class="flex-1">
   ...
   <?php if ($search): ?>
    <a href="/admin/clubs.php" class="btn btn--secondary btn--sm">
    <i data-lucide="x"></i>
    Rensa
    </a>
   <?php endif; ?>
  ...
  <div class="stat-card">
   <i data-lucide="building" class="icon-lg text-primary mb-md"></i>
  ...
  <div class="stat-card">
   <i data-lucide="users" class="icon-lg text-accent mb-md"></i>
   <div class="stat-number">
  ...
  <div class="card">
   ...
   <i data-lucide="building-2" class="gs-icon-xl text-secondary mb-md"></i>
   <p class="text-secondary">Inga klubbar hittades</p>
   </div>
  </div>
  <?php else: ?>
  <div class="card">
   ...
   <table class="table">
    ...
    <tr>
     ...
     <th class="col-tablet">Förkortning</th>
     <th class="col-tablet">
     <i data-lucide="map-pin"></i>
     Stad
     </th>
    ...
    <?php foreach ($clubs as $club): ?>
     ...
     <td class="text-secondary col-tablet"><?= h($club['city'] ?? '-') ?></td>
     <td class="gs-col-desktop">
      <span class="text-secondary">
      <?= h($club['country'] ?? 'Sverige') ?>
      </span>
     </td>
     <td class="text-center col-landscape">
      <strong class="text-primary"><?= $club['rider_count'] ?></strong>
     </td>
     <td class="gs-actions-col text-right">
