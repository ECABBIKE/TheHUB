...
<main class="gs-content-with-sidebar">
    <div class="gs-container">
        ...
        <div class="gs-card">
            ...
            <div class="gs-card-content">
                <form method="POST" enctype="multipart/form-data" class="gs-form">
                    ...
                    <div class="gs-form-group gs-mb-lg">
                        <label for="csv_file" class="gs-label gs-label-lg">
                            <span class="gs-badge gs-badge-primary gs-mr-sm">2</span>
                            CSV-fil
                        </label>
                        <input type="file" id="csv_file" name="csv_file" class="gs-input gs-input-lg" accept=".csv" required>
        ...
        <div class="gs-card gs-mt-lg">
            ...
            <div class="gs-card-content gs-text-sm">
                <p class="gs-mb-md">Det här verktyget hjälper dig att fylla i saknade UCI-ID innan du importerar resultat:</p>
                <ol class="gs-ml-md">
        ...
        <form method="POST" class="gs-form">
            ...
            <div class="gs-card gs-mb-lg">
                ...
                <div class="gs-card-content">
                    ...
                    <div class="gs-form-group">
                        ...
                        <select name="uci_choice_row_<?= $item['row_num'] ?>" class="gs-input">
            ...
            <div class="gs-flex gs-gap-md">
                <button type="submit" class="gs-btn gs-btn-primary gs-btn-lg gs-flex-1">
                    <i data-lucide="check"></i>
                    Spara & Gå till Preview
                </button>
                <a href="/admin/enrich-uci-id.php" class="gs-btn gs-btn-outline gs-btn-lg gs-flex-1">
                    <i data-lucide="x"></i>
                    Avbryt
                </a>
            </div>
