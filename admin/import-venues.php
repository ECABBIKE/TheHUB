...
<main class="gs-content-with-sidebar">
    <div class="gs-container">
            ...
            <div class="gs-card gs-mb-lg">
                ...
                <div class="gs-card-content">
                    ...
                    <div class="gs-mt-lg">
                        ...
                        <p class="gs-text-lg"><strong>Totalt i databasen:</strong> <?= $stats['total_in_db'] ?> anläggningar</p>
                    </div>
                </div>
            </div>
        <?php endif; ?>
        ...
        <div class="gs-card gs-mb-lg">
            <div class="gs-card-header">
                <h2 class="gs-h3">Bulk-import av anläggningar från CSV-fil</h2>
            </div>
            <div class="gs-card-content">
                <form method="POST" enctype="multipart/form-data" class="gs-form">
                    ...
                    <div class="gs-flex gs-gap-md">
                        ...
                        <a href="/admin/venues.php" class="gs-btn gs-btn-outline">
                            <i data-lucide="arrow-left"></i>
                            Tillbaka
                        </a>
                        <a href="/templates/import-venues-template.csv" class="gs-btn gs-btn-outline" download>
