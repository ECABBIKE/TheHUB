 ...
 * 
 * Två riders är samma person ENDAST om:
 ...
 * 4. Minst en tävlingsklass är gemensam
 */
        ...
        <div class="gs-card gs-mb-lg" style="background-color: #f0f7ff; border-left: 4px solid #0066cc;">
            <div class="gs-card-content">
                ...
                <ul style="margin: 0; padding-left: 20px; font-size: 13px; line-height: 1.6;">
                    ...
                    <li><strong>✓ KRÄVS:</strong> Minst en tävlingsklass är gemensam</li>
                </ul>
            </div>
        </div>
