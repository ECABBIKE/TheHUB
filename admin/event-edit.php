                    ...
                    <div class="gs-grid gs-grid-cols-1 gs-md-grid-cols-2 gs-gap-md">
                        ...
                        <div>
                            <label for="driver_meeting" class="gs-label">
                                ...
                                <label class="gs-checkbox-label gs-ml-md" style="display: inline-flex; font-weight: normal;">
                                    <input type="checkbox" name="driver_meeting_use_global" class="gs-checkbox" <?= !empty($event['driver_meeting_use_global']) ? 'checked' : '' ?>>
                        ...
                        <div>
                            <label for="training_info" class="gs-label">
                                ...
                                <label class="gs-checkbox-label gs-ml-md" style="display: inline-flex; font-weight: normal;">
                                    <input type="checkbox" name="training_use_global" class="gs-checkbox" <?= !empty($event['training_use_global']) ? 'checked' : '' ?>>
                                    <span class="gs-text-xs">Global</span>
                                </label>
                            </label>
                            <textarea
                        ...
                        <div>
                            <label for="timing_info" class="gs-label">
                                ...
                                <label class="gs-checkbox-label gs-ml-md" style="display: inline-flex; font-weight: normal;">
                                    <input type="checkbox" name="timing_use_global" class="gs-checkbox" <?= !empty($event['timing_use_global']) ? 'checked' : '' ?>>
                                    <span class="gs-text-xs">Global</span>
                                </label>
                            </label>
                            <textarea
                        ...
                        <div>
                            <label for="lift_info" class="gs-label">
                                ...
                                <label class="gs-checkbox-label gs-ml-md" style="display: inline-flex; font-weight: normal;">
                                    <input type="checkbox" name="lift_use_global" class="gs-checkbox" <?= !empty($event['lift_use_global']) ? 'checked' : '' ?>>
                                    <span class="gs-text-xs">Global</span>
                                </label>
                            </label>
                            <textarea
                        ...
                        <div>
                            <label for="hydration_stations" class="gs-label">
                                ...
                                <label class="gs-checkbox-label gs-ml-md" style="display: inline-flex; font-weight: normal;">
                                    <input type="checkbox" name="hydration_use_global" class="gs-checkbox" <?= !empty($event['hydration_use_global']) ? 'checked' : '' ?>>
                                    <span class="gs-text-xs">Global</span>
                                </label>
                            </label>
                            <textarea
                        ...
                        <div>
                            <label for="toilets_showers" class="gs-label">
                                ...
                                <label class="gs-checkbox-label gs-ml-md" style="display: inline-flex; font-weight: normal;">
                                    <input type="checkbox" name="toilets_use_global" class="gs-checkbox" <?= !empty($event['toilets_use_global']) ? 'checked' : '' ?>>
                                    <span class="gs-text-xs">Global</span>
                                </label>
                            </label>
                            <textarea
                        ...
                        <div>
                            <label for="bike_wash" class="gs-label">
                                ...
                                <label class="gs-checkbox-label gs-ml-md" style="display: inline-flex; font-weight: normal;">
                                    <input type="checkbox" name="bike_wash_use_global" class="gs-checkbox" <?= !empty($event['bike_wash_use_global']) ? 'checked' : '' ?>>
                                    <span class="gs-text-xs">Global</span>
                                </label>
                            </label>
                            <textarea
                        ...
                        <div>
                            <label for="food_cafe" class="gs-label">
                                ...
                                <label class="gs-checkbox-label gs-ml-md" style="display: inline-flex; font-weight: normal;">
                                    <input type="checkbox" name="food_use_global" class="gs-checkbox" <?= !empty($event['food_use_global']) ? 'checked' : '' ?>>
                                    <span class="gs-text-xs">Global</span>
                                </label>
                            </label>
                            <textarea
                        ...
                        <div>
                            <label for="shops_info" class="gs-label">
                                ...
                                <label class="gs-checkbox-label gs-ml-md" style="display: inline-flex; font-weight: normal;">
                                    <input type="checkbox" name="shops_use_global" class="gs-checkbox" <?= !empty($event['shops_use_global']) ? 'checked' : '' ?>>
                                    <span class="gs-text-xs">Global</span>
                                </label>
                            </label>
                            <textarea
                        ...
                        <div>
                            <label for="exhibitors" class="gs-label">
                                ...
                                <label class="gs-checkbox-label gs-ml-md" style="display: inline-flex; font-weight: normal;">
                                    <input type="checkbox" name="exhibitors_use_global" class="gs-checkbox" <?= !empty($event['exhibitors_use_global']) ? 'checked' : '' ?>>
                                    <span class="gs-text-xs">Global</span>
                                </label>
                            </label>
                            <textarea
                        ...
                        <div>
                            <label for="parking_detailed" class="gs-label">
                                ...
                                <label class="gs-checkbox-label gs-ml-md" style="display: inline-flex; font-weight: normal;">
                                    <input type="checkbox" name="parking_use_global" class="gs-checkbox" <?= !empty($event['parking_use_global']) ? 'checked' : '' ?>>
                                    <span class="gs-text-xs">Global</span>
                                </label>
                            </label>
                            <textarea
                        ...
                        <div>
                            <label for="hotel_accommodation" class="gs-label">
                                ...
                                <label class="gs-checkbox-label gs-ml-md" style="display: inline-flex; font-weight: normal;">
                                    <input type="checkbox" name="hotel_use_global" class="gs-checkbox" <?= !empty($event['hotel_use_global']) ? 'checked' : '' ?>>
                                    <span class="gs-text-xs">Global</span>
                                </label>
                            </label>
                            <textarea
                        ...
                        <div>
                            <label for="local_info" class="gs-label">
                                ...
                                <label class="gs-checkbox-label gs-ml-md" style="display: inline-flex; font-weight: normal;">
                                    <input type="checkbox" name="local_use_global" class="gs-checkbox" <?= !empty($event['local_use_global']) ? 'checked' : '' ?>>
                                    <span class="gs-text-xs">Global</span>
                                </label>
                            </label>
                            <textarea
                    ...
                    <div class="gs-grid gs-grid-cols-1 gs-md-grid-cols-2 gs-gap-md">
                        ...
                        <div>
                            <label for="competition_tracks" class="gs-label">
                                ...
                                <label class="gs-checkbox-label gs-ml-md" style="display: inline-flex; font-weight: normal;">
                                    <input type="checkbox" name="tracks_use_global" class="gs-checkbox" <?= !empty($event['tracks_use_global']) ? 'checked' : '' ?>>
                                    <span class="gs-text-xs">Global</span>
                                </label>
                            </label>
                            <textarea
                        ...
                        <div>
                            <label for="competition_rules" class="gs-label">
                                ...
                                <label class="gs-checkbox-label gs-ml-md" style="display: inline-flex; font-weight: normal;">
                                    <input type="checkbox" name="rules_use_global" class="gs-checkbox" <?= !empty($event['rules_use_global']) ? 'checked' : '' ?>>
                                    <span class="gs-text-xs">Global</span>
                                </label>
                            </label>
                            <textarea
                        ...
                        <div>
                            <label for="insurance_info" class="gs-label">
                                ...
                                <label class="gs-checkbox-label gs-ml-md" style="display: inline-flex; font-weight: normal;">
                                    <input type="checkbox" name="insurance_use_global" class="gs-checkbox" <?= !empty($event['insurance_use_global']) ? 'checked' : '' ?>>
                                    <span class="gs-text-xs">Global</span>
                                </label>
                            </label>
                            <textarea
                        ...
                        <div>
                            <label for="equipment_info" class="gs-label">
                                ...
                                <label class="gs-checkbox-label gs-ml-md" style="display: inline-flex; font-weight: normal;">
                                    <input type="checkbox" name="equipment_use_global" class="gs-checkbox" <?= !empty($event['equipment_use_global']) ? 'checked' : '' ?>>
                                    <span class="gs-text-xs">Global</span>
                                </label>
                            </label>
                            <textarea
                    ...
                    <div class="gs-grid gs-grid-cols-1 gs-md-grid-cols-2 gs-gap-md">
                        ...
                        <div>
                            <label for="entry_fees_detailed" class="gs-label">
                                ...
                                <label class="gs-checkbox-label gs-ml-md" style="display: inline-flex; font-weight: normal;">
                                    <input type="checkbox" name="fees_use_global" class="gs-checkbox" <?= !empty($event['fees_use_global']) ? 'checked' : '' ?>>
                                    <span class="gs-text-xs">Global</span>
                                </label>
                            </label>
                            <textarea
                        ...
                        <div>
                            <label for="results_info" class="gs-label">
                                ...
                                <label class="gs-checkbox-label gs-ml-md" style="display: inline-flex; font-weight: normal;">
                                    <input type="checkbox" name="results_use_global" class="gs-checkbox" <?= !empty($event['results_use_global']) ? 'checked' : '' ?>>
                                    <span class="gs-text-xs">Global</span>
                                </label>
                            </label>
                            <textarea
                        ...
                        <div>
                            <label for="medical_info" class="gs-label">
                                ...
                                <label class="gs-checkbox-label gs-ml-md" style="display: inline-flex; font-weight: normal;">
                                    <input type="checkbox" name="medical_use_global" class="gs-checkbox" <?= !empty($event['medical_use_global']) ? 'checked' : '' ?>>
                                    <span class="gs-text-xs">Global</span>
                                </label>
                            </label>
                            <textarea
                        ...
                        <div>
                            <label for="media_production" class="gs-label">
                                ...
                                <label class="gs-checkbox-label gs-ml-md" style="display: inline-flex; font-weight: normal;">
                                    <input type="checkbox" name="media_use_global" class="gs-checkbox" <?= !empty($event['media_use_global']) ? 'checked' : '' ?>>
                                    <span class="gs-text-xs">Global</span>
                                </label>
                            </label>
                            <textarea
                        ...
                        <div>
                            <label for="contacts_info" class="gs-label">
                                ...
                                <label class="gs-checkbox-label gs-ml-md" style="display: inline-flex; font-weight: normal;">
                                    <input type="checkbox" name="contacts_use_global" class="gs-checkbox" <?= !empty($event['contacts_use_global']) ? 'checked' : '' ?>>
                                    <span class="gs-text-xs">Global</span>
                                </label>
                            </label>
                            <textarea
                        ...
                        <div>
                            <label for="scf_representatives" class="gs-label">
                                ...
                                <label class="gs-checkbox-label gs-ml-md" style="display: inline-flex; font-weight: normal;">
                                    <input type="checkbox" name="scf_use_global" class="gs-checkbox" <?= !empty($event['scf_use_global']) ? 'checked' : '' ?>>
                                    <span class="gs-text-xs">Global</span>
                                </label>
                            </label>
                            <textarea
