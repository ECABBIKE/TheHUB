        ...
        <div class="gs-grid gs-grid-cols-1 gs-lg-grid-cols-2 gs-gap-lg">
            ...
            <div class="gs-card">
                ...
                <div class="gs-card-content">
                    ...
                    <a href="?download_template=1" class="gs-btn gs-btn-primary">
                        <i data-lucide="download"></i>
                        Ladda ner mall (CSV)
                    </a>

                    <div class="gs-mt-lg gs-text-sm gs-text-secondary">
                        <strong>Kolumner i mallen:</strong>
                        <ul class="gs-mt-sm" style="padding-left: 1.5rem;">
            ...
            <div class="gs-card">
                ...
                <div class="gs-card-content">
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="gs-mb-lg">
                            <label for="import_file" class="gs-label">Välj CSV-fil</label>
                            <input
                                type="file"
                                id="import_file"
                                name="import_file"
                        ...
                        <div class="gs-alert gs-alert-info gs-mb-lg">
                            ...
                            <div>
                                ...
                                <ul class="gs-mt-sm" style="padding-left: 1.5rem; margin: 0;">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php elseif ($result['status'] === 'updated'): ?>
                                                <span class="gs-badge gs-badge-primary">Uppdaterad</span>
                                            <?php else: ?>
                                                <span class="gs-badge gs-badge-danger">Fel</span>
                                            <?php endif; ?>
                                        </td>
