...
$admin_nav = [
    ...
    [
        ...
        'url' => '/admin/settings',
        'active' => in_array($current_admin_page, ['settings', 'public-settings', 'global-texts', 'tools', 'system-settings', 'role-permissions', 'pricing-templates', 'rebuild-stats', 'role-management', 'club-admins']),
        'min_role' => 'admin'
    ]
];
