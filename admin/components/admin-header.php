...
<header class="page-header">
    ...
    <div class="header-right">
        <?php if (!isRole('promotor')): ?>
        <!-- Quick Actions - Hidden for promotors -->
        <a href="/admin/events/create" class="header-action" title="Skapa event">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14"/><path d="M12 5v14"/></svg>
            <span class="action-label">Nytt Event</span>
        </a>

        <a href="/admin/import" class="header-action" title="Importera">
        ...
        <div class="user-menu">
            ...
            <div class="user-dropdown" id="userDropdown">
                ...
                <!-- Theme Switcher -->
                <div class="admin-dropdown-theme">
                    ...
                    <div class="theme-options">
                        <button class="theme-btn theme-option-btn" data-theme-set="light" title="Ljust tema">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <circle cx="12" cy="12" r="4"/>
                                <path d="M12 2v2M12 20v2M4.93 4.93l1.41 1.41M17.66 17.66l1.41 1.41M2 12h2M20 12h2M6.34 17.66l-1.41 1.41M19.07 4.93l-1.41 1.41"/>
                            </svg>
                        </button>
                        <button class="theme-btn theme-option-btn" data-theme-set="auto" title="Automatiskt">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        ...
                        <button class="theme-btn theme-option-btn" data-theme-set="dark" title="Mörkt tema">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
