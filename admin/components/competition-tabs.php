 ...
 * Include this file in all pages under Tävlingar group
 *
...
<!-- Competition Tabs -->
<div class="tabs">
    <a href="/admin/events" class="tab-btn <?= $active_tab === 'events' ? 'active' : '' ?>">
    ...
    <a href="/admin/results.php" class="tab-btn <?= $active_tab === 'results' ? 'active' : '' ?>">
    ...
    <a href="/admin/classes" class="tab-btn <?= $active_tab === 'classes' ? 'active' : '' ?>">
    ...
    <a href="/admin/orders.php" class="tab-btn <?= $active_tab === 'payments' ? 'active' : '' ?>">
