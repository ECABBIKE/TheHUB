                        ...
                        <div class="gs-table-container">
                            <table class="gs-table">
                                <thead>
                                    <tr>
                                        <th>Event</th>
                                        <th class="gs-text-center">Redigera</th>
                                        <th class="gs-text-center">Resultat</th>
                                        <th class="gs-text-center">Anmälningar</th>
                                        <th></th>
                                    </tr>
                                </thead>
                                <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <form method="POST" class="event-perm-form" data-event="<?= $event['event_id'] ?>">
                                                ...
                                                <td class="gs-text-center">
                                                    <input type="checkbox" name="can_edit" value="1" <?= $event['can_edit'] ? 'checked' : '' ?> onchange="this.form.submit()" class="gs-checkbox-input">
                                                </td>
                                                <td class="gs-text-center">
                                                    <input type="checkbox" name="can_manage_results" value="1" <?= $event['can_manage_results'] ? 'checked' : '' ?> onchange="this.form.submit()" class="gs-checkbox-input">
                                                </td>
                                                <td class="gs-text-center">
                                                    <input type="checkbox" name="can_manage_registrations" value="1" <?= $event['can_manage_registrations'] ? 'checked' : '' ?> onchange="this.form.submit()" class="gs-checkbox-input">
                                                </td>
                                            </form>
            ...
            <div class="gs-card-content">
                <form method="POST">
                    ...
                    <div class="gs-grid gs-grid-cols-1 gs-md-grid-cols-2 gs-gap-md">
                        <div>
                            <label for="series_id" class="gs-label">Välj serie</label>
                            <select id="series_id" name="series_id" class="gs-input" required>
                        ...
                        <div class="gs-flex gs-items-end">
                            <button type="submit" class="gs-btn gs-btn-outline">
                                <i data-lucide="plus"></i>
                    ...
                    <div class="gs-mt-md">
                        <label class="gs-label">Behörigheter för alla events</label>
