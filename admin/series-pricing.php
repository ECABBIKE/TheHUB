...
<main class="gs-content-with-sidebar">
    <div class="gs-container">
        ...
        <div class="gs-tabs gs-mb-lg">
            <a href="?id=<?= $seriesId ?>&tab=pricing" class="gs-tab <?= $activeTab === 'pricing' ? 'active' : '' ?>">
                <i data-lucide="credit-card"></i>
                Priser
            </a>
            <a href="?id=<?= $seriesId ?>&tab=rules" class="gs-tab <?= $activeTab === 'rules' ? 'active' : '' ?>">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" name="early_bird_discount[]" class="gs-input"
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="allowed_licenses[]" class="gs-input"
                                        ...
                                        <td>
                                            <div class="gs-flex gs-gap-sm">
                                                <input type="number" name="min_birth_year[]" class="gs-input"
                                                       value="<?= $rule['min_birth_year'] ?? '' ?>"
                                                       placeholder="1990" style="width: 70px;">
                                                <span>-</span>
                                                <input type="number" name="max_birth_year[]" class="gs-input"
                                                       value="<?= $rule['max_birth_year'] ?? '' ?>"
                                                       placeholder="2010" style="width: 70px;">
                                            </div>
                                        </td>
                                        <td>
                                            <input type="text" name="allowed_genders[]" class="gs-input"
