    ...
    <div class="gs-container">
                ...
                <form method="POST" id="venueForm">
                    ...
                    <div class="gs-modal-body">
                        <div class="gs-grid gs-grid-cols-1 gs-gap-md">
                            ...
                            <!-- Address -->
                            <div>
                                <label for="address" class="gs-label">
                            ...
                            <div class="gs-grid gs-grid-cols-2 gs-gap-md">
                                <div>
                                    <label for="gps_lat" class="gs-label">
                                ...
                                <div>
                                    <label for="gps_lng" class="gs-label">
                                        <i data-lucide="navigation"></i>
                                        GPS Longitud
                                    </label>
                                    <input
                    ...
                    <div class="gs-modal-footer">
                        <button type="button" class="gs-btn gs-btn-outline" onclick="closeVenueModal()">
                            Avbryt
                        </button>
        ...
        <div class="gs-grid gs-grid-cols-1 gs-md-grid-cols-3 gs-gap-lg gs-mb-lg">
            <div class="gs-stat-card">
                <i data-lucide="map-pin" class="gs-icon-lg gs-text-primary gs-mb-md"></i>
