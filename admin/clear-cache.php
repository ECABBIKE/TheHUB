...
if (file_exists($rankingFile)) {
    ...
    if (strpos($content, '2025-11-25-001') !== false) {
        echo "<p style='color: green;'>✅ Version 2025-11-25-001 found in file!</p>";
    } else {
        echo "<p style='color: red;'>❌ Version 2025-11-25-001 NOT found in file!</p>";
