        ...
        <div class="gs-card gs-mb-lg">
            ...
            <div class="gs-card-content">
                <div class="gs-text-center">
                    <span class="gs-text-4xl gs-font-bold gs-text-warning"><?= $incompleteCount ?></span>
                    <span class="gs-text-secondary"> ryttare</span>
                </div>
            </div>
        </div>
            ...
            <div class="gs-card-content">
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="gs-form-group">
                        <label class="gs-label">Välj CSV-fil</label>
                        <input type="file" name="csv_file" accept=".csv,.txt" class="gs-input" required>
                        <small class="gs-text-secondary">CSV med semikolon (;) eller komma (,) som separator</small>
                    </div>
        ...
        <div class="gs-card gs-mb-lg">
            <div class="gs-card-header gs-flex gs-justify-between gs-items-center">
                ...
                <form method="POST" style="display: inline;">
                    ...
                    <button type="submit" class="gs-btn gs-btn-success" onclick="return confirm('Tillämpa alla <?= count($matches) ?> uppdateringar?')">
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php foreach ($match['updates'] as $field => $value): ?>
                                        <span class="gs-badge gs-badge-success gs-mr-xs">
                                            <?= h($field) ?>: <?= h($value) ?>
                                        </span>
                                    <?php endforeach; ?>
                                </td>
                    ...
                    <table class="gs-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="<?= empty($rider['birth_year']) ? 'gs-text-error' : '' ?>">
                                    <?= $rider['birth_year'] ?: '❌ Saknas' ?>
                                </td>
                                <td class="<?= empty($rider['email']) ? 'gs-text-error' : '' ?>">
                                    <?= $rider['email'] ?: '❌ Saknas' ?>
                                </td>
                                <td class="<?= empty($rider['license_type']) ? 'gs-text-error' : '' ?>">
