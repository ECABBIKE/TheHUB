            ...
            <div class="gs-card-content">
                <form method="POST">
                    ...
                    <div class="gs-form-group gs-mb-md">
                        <label class="gs-label">Event med resultat</label>
                        <select name="event_id" class="gs-input" required>
                    ...
                    <div class="gs-flex gs-gap-md">
                        <button type="submit" name="preview_classes" class="gs-btn gs-btn-outline">
                            <i data-lucide="eye"></i>
                            Förhandsgranska
                        </button>
                        <button type="submit" name="reassign_classes" class="gs-btn gs-btn-warning"
